...
public class WebViewActivity extends ActionBarActivity implements AdapterView.OnItemSelectedListener {
    ...
    String apikey,sitename,Token,CustomizeLanguage,action,spinview,preaction,facebook_native,google_native,resetPasswordUrl,sott;
    private Button btnSignUp;
    String verificationUrl,emailTemplate,smsTemplate,isMobile,promptPasswordOnSocialLogin,userlogin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        apikey = getIntent().getExtras().getString("keyName");
        ...
        preaction=getIntent().getExtras().getString("preaction");
        ...
        params.put("provider",action.toLowerCase());
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                if (url.contains("?token")) {
                    ...
                    if(Token != null){
                        ...
                        accessToken.provider = action;
                        accessToken.apikey=apikey;
                        if(preaction!=null && preaction.equals("Linking")){
                            ...
                            userAPI.getResponse(accessToken, new AsyncHandler<LoginRadiusUltimateUserProfile>() {
                                ...
                                public void onSuccess(final LoginRadiusUltimateUserProfile userProfile) {
                                    ...
                                    try {
                                        for (Field field : userProfile.getClass().getDeclaredFields()) {
                                            ...
                                            SharedPreferences.Editor editor = getSharedPreferences(Endpoint.SHAREDPREFERENCEFILEKEY, MODE_PRIVATE).edit();
                                            editor.putString("webtoken", Token);
                                            editor.putString("webprovider",action);
                                            editor.apply();
                                ...
                                public void onFailure(Throwable error, String errorcode) {
                                    ...
                                    if (errorcode.equals("lr_API_NOT_SUPPORTED")){
                                        Toast.makeText(WebViewActivity.this, errorcode, Toast.LENGTH_LONG).show();
                                    }else {
                                        ...
                                        for (Object i : ad) {
                                            ...
                                            if (customerror.containsKey("error" + errorResponse.getErrorCode())) {
                                                Toast.makeText(WebViewActivity.this, customerror.get("error" + errorResponse.getErrorCode()).toString(), Toast.LENGTH_LONG).show();
                                            } else {
    ...
    private void UpdateProfile(){
        ...
        RestRequest.put(WebViewActivity.this, Endpoint.getUpdateProfileUrl(),params,new Gson().toJson(update),new AsyncHandler<String>() {
            @Override
            public void onSuccess(String response) {
                ...
                if(registerResponse.getIsPosted()){
                    ...
                    if (isMobile!=null && isMobile.equals("true")) {
                    ...
                    }else if(userlogin!=null && userlogin.equals("true") &&inputemailid.getVisibility()==View.VISIBLE && isMobile!="true") {
                        ...
                        startActivityForResult(intent, 2);
                        Toast.makeText(WebViewActivity.this, customizeLanguageResponse.successMessage.get(0).getRegistermessage(), Toast.LENGTH_LONG).show();
                    ...
                    } else if (userlogin!="true" &&!(inputemailid.getVisibility()==View.VISIBLE ) && isMobile!="true"){
