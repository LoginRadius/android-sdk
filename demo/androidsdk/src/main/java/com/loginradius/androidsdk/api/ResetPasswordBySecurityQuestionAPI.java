...
public class ResetPasswordBySecurityQuestionAPI {
    ...
    public void getResponse(LoginParams value,JsonObject update , final AsyncHandler<RegisterResponse> handler)
    {
        ...
        apiService.getResetPasswordbySecurityQuestion(Endpoint.API_V2_RESET_PASSWORD_BY_SECURITY_QUESTION,params,update).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread())
