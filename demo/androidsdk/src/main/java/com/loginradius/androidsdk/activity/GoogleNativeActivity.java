...
public class GoogleNativeActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    String lrapikey,sitename,CustomizeLanguage,spinview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linlaHeaderProgress = (LinearLayout) findViewById(R.id.li);
                ...
                userAPI.getResponse(accessToken, new AsyncHandler<LoginRadiusUltimateUserProfile>() {
                    ...
                    public void onFailure(Throwable error, String errorcode) {
                        ...
                        if (errorcode.equals("lr_API_NOT_SUPPORTED")){
                            Toast.makeText(GoogleNativeActivity.this, errorcode, Toast.LENGTH_LONG).show();
                        }else {
                            ...
                            for (Object i : ad) {
                                ...
                                if (customerror.containsKey("error" + errorResponse.getErrorCode())) {
                                    Toast.makeText(GoogleNativeActivity.this, customerror.get("error" + errorResponse.getErrorCode()).toString(), Toast.LENGTH_LONG).show();
                                } else {
                                    Toast.makeText(GoogleNativeActivity.this, error.getMessage(), Toast.LENGTH_LONG).show();
                                }
                            }
                        }
                    }
    ...
    private void UpdateProfile(){
        ...
        RestRequest.put(GoogleNativeActivity.this, Endpoint.getUpdateProfileUrl(),params,new Gson().toJson(update),new AsyncHandler<String>() {
            @Override
            public void onSuccess(String response) {
                ...
                if(registerResponse.getIsPosted()){
                    ...
                    if (isMobile!=null && isMobile.equals("true")) {
                        ...
                        Toast.makeText(GoogleNativeActivity.this, customizeLanguageResponse.successMessage.get(0).getRegistermessage(), Toast.LENGTH_LONG).show();
