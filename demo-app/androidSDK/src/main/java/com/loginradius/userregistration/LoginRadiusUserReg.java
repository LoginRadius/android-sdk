...
public abstract class LoginRadiusUserReg extends WebView {
    ...
    public void loadLoginPage(){
       ...
       params.put("V2RecaptchaSiteKey",options.getrecaptchakey());
        params.put("action", "login");
        params.put("promptPasswordOnSocialLogin",options.getPrompt_password());
    ...
    public void loadFacebooknative_login(){
        ...
        params.put("apikey",options.getAPI_KEY());
        params.put("sitename", options.getAPP_Name());
        params.put("lrtoken",options.getfacebooknativetoken());
    ...
    private class WebAppInterface {
       ...
       /* @JavascriptInterface
        public void getsocial_action(String social_action) {
            SharedPreferences.Editor editor = mContext.getSharedPreferences(
                    StrResource.SHAREDPREFERENCEFILEKEY,mContext.MODE_PRIVATE).edit();
            editor.putString("lrtoken", accessToken);
            editor.commit();
