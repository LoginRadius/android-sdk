...
public class GoogleNativeActivity extends ActionBarActivity {
    ...
    ProgressBar bar;
    private String ApplicationActivteyId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ApplicationActivteyId= getIntent().getExtras().getString("ApplicationActivityId");
    ...
    public void sendAccessToken(String accessToken){
        ...
        Intent intent = new Intent(ApplicationActivteyId);
